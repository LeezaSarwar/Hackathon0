#!/usr/bin/env python3
"""
GMAIL DRAFT GENERATOR - Improved version with file input
...
print("\n" + "="*60)
print("GMAIL DRAFT GENERATOR - IMPROVED")
print("="*60 + "\n")
...
print("How do you want to provide the email?")
print("1. Type/paste directly (single line)")
print("2. Read from file (for long emails)")
print("-" * 60)
choice = input("> ")

if choice == "2":
    print("\nPaste the email content into a text file and save it.")
    print("Then enter the file path:")
    print("-" * 60)
    file_path = input("> ")
    ...
    print()
    print("Enter the email body (paste and press Enter):")
    print("TIP: For long emails, use option 2 (file input)")
    print("-" * 60)
    email_body = input("> ")

    if not email_body.strip():
        print("❌ No email body entered")
        print("\nTIP: For long emails, restart and choose option 2")
        sys.exit(1)
...
**Task File:** `{filename}`
**Generated by:** Gmail Draft Generator (Improved)
"""
